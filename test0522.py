...
Server: nginx
Date: Thu, 27 Sep 2018 01:15:40 GMT
Content-Type: text/html
Content-Length: 154
Connection: close
Location: https://www.sina.com.cn/
X-Via-CDN: f=edge,s=cnc.beixian.ha2ts4.213.nb.sinaedge.com,c=218.94.89.51;
X-Via-Edge: 153801094005633595edade9d7e7b57376a23
...
msg.attach(MIMEText('<html><body><h1></h1><p><img src = "cid:0"></p></body></html>', 'html', 'utf-8'))
...
# 邮件正文是MIMEText     #附加纯文本。如果无法查看HTML，则自动降级查看纯文本
...
#创建ssl安全连接
server.starttls()   创建SMTP对象后，立刻调用starttls()方法
...
'''
掌握各种邮件类型的构造方法，正确设置好邮件头
# 构造一个邮件对象        —— 一个Messag对象
# 构造一个文本邮件对象    —— 一个MIMEText对象
# 一个作为附件的图片      —— 一个MIMEImage对象
# 多个对象组合            —— MIMEMultipart对象
# 任何对象                —— MIMEBase对象
